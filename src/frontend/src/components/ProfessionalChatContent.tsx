...
const ProfessionalChatContent: React.FC<Props> = ({ thread, processingStepMsg }) => {
    ...
    const EmptyState = () => (
        <div style={{
            ...
            <div>
                <h2 style={{ margin: '0 0 20px 0', color: 'var(--colorNeutralForeground1)' }}>Ready to explore your data?</h2>
                <p style={{ margin: '0', color: 'var(--colorNeutralForeground2)' }}>Ask me anything about your uploaded documents.</p>
            </div>
        </div>
    );
